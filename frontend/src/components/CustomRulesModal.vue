      ...
      <div class="mt-3 text-center">
        ...
        <div class="mt-2 px-7 py-3">
          <textarea 
            ...
            placeholder="Введите правила исключения по одному на строку, например *.log или node_modules/"
          ></textarea>
...
const props = defineProps({
  ...
  title: {
    type: String,
    default: 'Изменение пользовательских правил'
  },
  ruleType: {
    type: String,
    required: true,
...
const descriptionText = computed(() => {
  if (props.ruleType === 'prompt') {
    return 'Эти правила содержат дополнительные указания для модели и будут включены в итоговую инструкцию.';
  }
  // Default to the description for ignore rules
  return 'Используется синтаксис шаблонов .gitignore. Правила применяются, когда включён соответствующий переключатель.';
});
