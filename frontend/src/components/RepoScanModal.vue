  ...
  <div v-if="isVisible" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex justify-center items-center" @click.self="handleCancel">
    <div class="relative mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
      <div class="mt-3 text-center">
        <h3 class="text-lg leading-6 font-medium text-gray-900">Описание репозитория</h3>
        <div class="mt-2 px-7 py-3">
          <textarea 
            ...
            placeholder="Вставьте описание структуры репозитория…"
          ></textarea>
          <p class="text-xs text-gray-500 mt-1 text-left">
            Описание добавляется к инструкции и помогает модели понять структуру репозитория и выбрать подходящий контекст. Поддерживается любой текстовый формат.
            Создать описание можно на <a href="#" @click.prevent="openLink" class="text-blue-600 hover:underline">shotgunpro.dev</a>.
          </p>
        </div>
